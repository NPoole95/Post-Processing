...
cbuffer PostProcessingConstants : register(b1) 
{
    ...
    float gHueWiggle;
    float gHueWiggleSpeed;
    float2 paddingD; // Pad things to collections of 4 floats (see notes in earlier labs to read about padding)
